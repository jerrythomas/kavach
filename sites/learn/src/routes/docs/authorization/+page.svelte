...
<div class="max-w-4xl">
	<h1 class="text-3xl font-bold mb-4">Authorization</h1>
	...
	<section class="mb-8">
		<h2 class="text-xl font-semibold mb-4">Route Rules</h2>
		<p class="mb-4">Define protection rules in your configuration:</p>
		<pre class="bg-surface-z1 p-4 rounded-lg overflow-x-auto"><code>{rulesConfig}</code></pre>
	</section>
	...
	<section class="mb-8">
		...
		<div class="space-y-4">
			<div>
				<h3 class="font-semibold mb-2">public: true</h3>
				<p class="text-surface-z7">Accessible without authentication.</p>
			</div>

			<div>
				<h3 class="font-semibold mb-2">protected: true</h3>
				<p class="text-surface-z7">Requires authentication (any logged-in user).</p>
			</div>

			<div>
				<h3 class="font-semibold mb-2">roles: ['role1', 'role2']</h3>
	...
	<section class="mb-8">
		<h2 class="text-xl font-semibold mb-4">Role-Based Redirects</h2>
		<p class="mb-4">After login, redirect users to role-specific pages:</p>
		<pre class="bg-surface-z1 p-4 rounded-lg overflow-x-auto"><code>{roleHome}</code></pre>
	</section>

	<section class="mb-8">
		<h2 class="text-xl font-semibold mb-4">Using Sentry</h2>
		<p class="mb-4">For fine-grained control, use Sentry directly:</p>
		<pre class="bg-surface-z1 p-4 rounded-lg overflow-x-auto"><code>{guardianCode}</code></pre>
	</section>
	...
	<section>
		...
		<ul class="space-y-2">
			<li><a href="/docs/configuration" class="text-primary hover:underline">Configuration options</a></li>
			<li><a href="/docs/session" class="text-primary hover:underline">Session management</a></li>
			<li><a href="/docs/guardian" class="text-primary hover:underline">Sentry documentation</a></li>
		</ul>
	</section>
</div>
